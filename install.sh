...
echo -e "${GREEN}==============================================================================${NC}"
echo ""
echo -e "${BOLD}🚀 First-Run Onboarding & Administrator Provisioning:${NC}"
echo -e "  When you first launch PulseWork, the ${CYAN}${BOLD}First-Run Setup Wizard${NC} will automatically"
echo -e "  guide you to configure your Organization profile, Peppol BIS 3.0 scheme, and create"
echo -e "  the ${GREEN}${BOLD}Primary Super Administrator${NC} account (with password, PIN & optional 2FA)."
echo ""
...
echo ""
echo -e "${PURPLE}Refer to ${BOLD}INSTALL.md${NC}${PURPLE} for full Nginx, SSL, PM2, and First-Run setup guides.${NC}"
echo ""
