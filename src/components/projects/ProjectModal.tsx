...
export const ProjectModal: React.FC<ProjectModalProps> = ({ project, onClose }) => {
  ...
  const [budgetHours, setBudgetHours] = useState(project?.budgetHours || 100)
  const [hourlyRate, setHourlyRate] = useState(project?.hourlyRate || 110)
  const [budgetAmount, setBudgetAmount] = useState(project?.budgetAmount || 11000)
